...
void TIM1_UP_IRQHandler(void)
{
  ...
  TSK_DualDriveFIFOUpdate(Exec_IRQ_Handler(MC_IRQ_PWMNCURRFDBK_1,0));
}

/**
  * @brief  This function handles TIM8 Update interrupt request.
  * @param  None
  * @retval None
  */
void TIM8_UP_IRQHandler(void)
{
  ...
  TSK_DualDriveFIFOUpdate(Exec_IRQ_Handler(MC_IRQ_PWMNCURRFDBK_2,1));
}
