...
/* State observer constants */
#define CORD_GAIN12                    -24129
#define CORD_GAIN22                    16793
...
#define LOW_SIDE_SIGNALS_ENABLING2     LS_DISABLED
#define SW_DEADTIME_NS2                1500 /*!< Dead-time to be inserted  
...
#define PID_TORQUE_KP_DEFAULT2         2996       
#define PID_TORQUE_KI_DEFAULT2         437
#define PID_TORQUE_KD_DEFAULT2         100
#define PID_FLUX_KP_DEFAULT2           2996
#define PID_FLUX_KI_DEFAULT2           437
...
#define OV_VOLTAGE_THRESHOLD_V2         48 /*!< Over-voltage 
                                                         threshold */
#define UD_VOLTAGE_THRESHOLD_V2         8 /*!< Under-voltage 
                                                          threshold */
#define ON_OVER_VOLTAGE2                TURN_OFF_PWM /*!< TURN_OFF_PWM, 
                                                         TURN_ON_R_BRAKE or 
                                                         TURN_ON_LOW_SIDES */
#define R_BRAKE_SWITCH_OFF_THRES_V2     38

#define OV_TEMPERATURE_PROT_ENABLING2   DISABLE
#define OV_TEMPERATURE_THRESHOLD_C2     70  /*!< Celsius degrees */
#define OV_TEMPERATURE_HYSTERESIS_C2    10  /*!< Celsius degrees */

#define HW_OV_CURRENT_PROT_BYPASS2      ENABLE /*!< In case ON_OVER_VOLTAGE  
...
#define FINAL_I_ALIGNMENT2              26208 /*!< s16A */
...
#define  FLUX_WEAKENING_ENABLING2       DISABLE
...
#define CONSTANT1_Q2                    45631
#define CONSTANT1_D2                    45631
#define CONSTANT2_QD2                   60806
